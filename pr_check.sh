...
COMPONENTS+=" archive-sync rules-processing rules-uploader parquet-factory"  # Internal Data Pipeline components
...
EXTRA_DEPLOY_ARGS="--set-parameter ccx-data-pipeline/IMAGE=quay.io/cloudservices/ccx-data-pipeline --set-parameter dvo-extractor/IMAGE=quay.io/cloudservices/ccx-data-pipeline"

export IQE_PLUGINS="ccx"
# Run all pipeline and ui tests
export IQE_MARKER_EXPRESSION="pipeline or internal"
